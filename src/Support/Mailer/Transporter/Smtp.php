...
class Smtp extends Transporter
{
    ...
    /**
     * @return \Greg\Support\Mailer\Protocol\Smtp
     * @throws \Exception
     */
    public function getConnection()
    {
        ...
        if (!$connection) {
            $connection = new \Greg\Support\Mailer\Protocol\Smtp($this->fetchRemoteAddress(), $this->timeout());
