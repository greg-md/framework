...
class ArrayObjectE extends \ArrayObject
{
    public function __construct($input = [])
    {
        // Under construction...i will think if it will be useful or not
        parent::__construct(Arr::bring($input), static::ARRAY_AS_PROPS);
